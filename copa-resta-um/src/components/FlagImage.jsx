const CODE = {
  ...
  'Bósnia-Herzegovina':'ba','Qatar':'qa','Catar':'qa','Suíça':'ch',
  ...
  'Jordânia':'jo','Portugal':'pt','RD Congo':'cd','Uzbequistão':'uz',
  'Colômbia':'co','Inglaterra':'gb-eng','Croácia':'hr','Panamá':'pa',
  'Gana':'gh','Honduras':'hn','Jamaica':'jm','Venezuela':'ve',
  'Camarões':'cm','Nigéria':'ng','Sérvia':'rs','Polônia':'pl',
  'Dinamarca':'dk',
}
...
export default function FlagImage({ team, size='md', grayscale=false, style:extraStyle={}, className='' }) {
  ...
  if (!code) return (
    <div style={{
      ...
      border:'1px solid #E5E7EB', ...extraStyle,
    }} className={className}>
