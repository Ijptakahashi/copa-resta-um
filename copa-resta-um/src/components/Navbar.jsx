    ...
    <>
      ...
      <nav className="bottom-nav">
        ...
        <NavLink to="/pick" className={({isActive})=>isActive?'active':''}>
          <span className="icon">⚽</span>Pick
        </NavLink>
        <NavLink to="/rankings" className={({isActive})=>isActive?'active':''}>
          <span className="icon">📊</span>Ranking
        </NavLink>
        <NavLink to="/all-picks" className={({isActive})=>isActive?'active':''}>
          <span className="icon">👀</span>Picks
        </NavLink>
        <NavLink to="/inventory" className={({isActive})=>isActive?'active':''}>
          <span className="icon">🗂️</span>Inventário
        </NavLink>
      </nav>
    </>
  )
